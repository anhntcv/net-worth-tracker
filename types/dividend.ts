...
export interface Dividend {
  ...
  // True for an inflation-linked coupon materialized with ONLY the guaranteed fixed rate, while the
  // FOI inflation component for that period has not yet been announced by the user. Cleared once the
  // user enters the announced rate and the coupon is recomputed (fixed + inflation).
  // WARNING: surfaced as a "Provvisoria" badge in DividendTable / DividendRecordDetailsDialog and
  // filtered by ProvisionalCouponBanner — keep those in sync.
...
export interface DividendFormData {
  ...
  // See Dividend.isProvisional — set by the coupon scheduler for inflation-linked bonds whose
  // FOI inflation rate for the period is not yet announced.
  isProvisional?: boolean;
